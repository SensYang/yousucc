...
//							isAutoScale = true;
	...
	public void onGlobalLayout() {
		if (!mOnce) {
			...
			Log.d("Debug", "width:" + width + ",height:" + height + ",dw:" + dw + ",dh:" + dh);
	...
	public boolean onScale(ScaleGestureDetector detector) {
		...
		if ((scale < mMaxScale && scaleFactor > 1.0f)
			 ...
			 */
			mScaleMatrix.postScale(scaleFactor, scaleFactor, detector.getFocusX(), detector.getFocusY());// detector.getFocusX(),
